            ...
            <c:if test="${not empty student}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="password" class="form-control" id="newPassword" name="newPassword" placeholder="Để trống nếu không muốn đổi">
                    </div>
                </div>
            </c:if>

            <button type="submit" class="btn btn-primary mt-3">Lưu lại</button>
            <a href="${pageContext.request.contextPath}/admin/students" class="btn btn-secondary mt-3">Hủy</a>
        </form>
    </div>
</div>
